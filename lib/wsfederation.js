...
WsFederation.prototype = {
  getRequestSecurityTokenUrl: function () {
    if (this.homerealm !== '')
    {
      return "https://" + this.identityProviderUrl + ".accesscontrol.windows.net/v2/wsfederation/?wtrealm=" + this.realm + "&wa=wsignin1.0&whr=" + this.homerealm;   
    }
    else
    {
      return "https://" + this.identityProviderUrl + ".accesscontrol.windows.net/v2/wsfederation/?wtrealm=" + this.realm + "&wa=wsignin1.0";
    } 
  },
